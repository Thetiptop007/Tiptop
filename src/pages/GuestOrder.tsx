          ...
          <div className="mb-6 rounded-lg bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800 p-4 text-left">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-700 dark:text-gray-300">If you have any questions or need to cancel, please call us at <a href="tel:+919060557296" className="text-blue-600 font-bold">9060557296</a>.</p>
              </div>
            </div>
          </div>
